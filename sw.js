/* ============================================================
   ...
   Versão v4 — correções:
     1. "body already used": agora retorna o CLONE para o browser
        e guarda o original no cache (padrão correto)
     2. isLocal não depende mais de fetchPromise ser truthy
        (fetchPromise é sempre uma Promise, logo sempre truthy)
   ============================================================ */

const CACHE_NOME    = 'agenda-v4';
const CACHE_EXTERNO = 'agenda-cdn-v4';
